...
std::uint32_t find_strip_by_sequence_point(ProjectorState *projector,
  ...
  SequencePoint *gate_strip_start =
      &projector->reel[projector->gate_strip_start_position].gate_strip_start;

  std::uint32_t offset = current_strip_contains_sequence_point(
      gate_strip_start, strip_start, strip_length);
  ...
  while (offset == max_uint32) {
    ...
    std::int8_t comparison_result =
        compare_sequence_point(gate_strip_start, strip_start);
    ...
    gate_strip_start =
        &projector->reel[projector->gate_strip_start_position].gate_strip_start;
    // Set offset
    offset = current_strip_contains_sequence_point(gate_strip_start,
                                                   strip_start, strip_length);
  }
  return offset;
}
