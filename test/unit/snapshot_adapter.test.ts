...
describe('Snapshot buffer transfer', () => {
  ...
  const projection = [
    ...[7, 2, 70, 80, 0, 0, 0, 0, absent, absent, 2, 0],
    ...[1, 3, 10, 20, 0, 0, 0, 0, 2, absent, 0, 0],
    ...[1, 0, absent, absent, absent, 10, 20, 0, absent, absent, 3, 0],
    ...[7, 2, 70, 80, 3, 0, 0, 0, absent, absent, 2, 0],
    ...[0, 1, 30, 40, 0, 0, 0, 0, absent, absent, 1, 0],
    ...[4, 1, 90, 91, 3, 99, 98, 0, absent, absent, 1, 0],
    ...[5, 2, 77, 80, 6, 99, 98, 0, absent, absent, 0, 0],
    ...[3, 2, 90, 91, 0, 99, 98, 0, absent, absent, 2, 0],
  ]
  const spans = [
    0,
    8,
